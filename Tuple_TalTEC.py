...
def insert_tuple_inside_tuple(outer_tuple: tuple, position: int, inner_tuple: tuple) -> tuple:
    ...
    inner_list = list(inner_tuple)
    for element in inner_list:
        outer_list.insert(position + inner_list.index(element), element)
    print(tuple(outer_list))


insert_tuple_inside_tuple((1, 2), 0, (3, 4))
insert_tuple_inside_tuple((1, 2), 1, (3, 4))
insert_tuple_inside_tuple((1, 2), 2, (3, 4))
insert_tuple_inside_tuple((1, 2, 3), 1, (1, ))
